        ...
        <div className="container mx-auto px-8 md:px-4 py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4" src="https://media2.giphy.com/media/6Mh8DXPL27UpNYp8o4/giphy.gif?cid=6c09b952c3n4u3jxyyiqlsvqs81vnk2qk92co9meqadax7al&ep=v1_internal_gif_by_id&rid=giphy.gif&ct=g" alt="Fans Want to Collaborate" />
                    <div>
                ...
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4" src="https://media4.giphy.com/media/OccMlQrNO0YU4zFchY/giphy.gif?cid=6c09b9524xdw7mwtngnuedcn6zwd3xrruqsqq3lrohstf2xc&ep=v1_internal_gif_by_id&rid=giphy.gif&ct=s" alt="Support Through Chai" />
                    <div>
